...
`{NumComma}` can convert between comma-separated and non-comma-separated numbers every three digits on R. It also has the `*_str` function for handling comma-separated and non-comma-separated numbers in a string.

It also has the `*_str` function to handle comma-separated and non-comma-separated numbers in a string.
